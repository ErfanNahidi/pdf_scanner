...
class PDFScanner:
    ...
    def _find_pdfid(self) -> Optional[Path]:
        """Find pdfid.py with better path resolution (including src/pdfid)."""
        base_dir = Path(__file__).parent
        potential_paths = [
            base_dir / "src" / "pdfid" / "pdfid.py",
            base_dir / "pdfid" / "pdfid.py",
            base_dir.parent / "src" / "pdfid" / "pdfid.py",
            base_dir.parent / "pdfid" / "pdfid.py",
